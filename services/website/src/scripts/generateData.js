...
async function main() {
        ...
        navigation: {
            general: {
                ...
                navItems: [
                    ...
                    {
                        name: 'Staking',
                        href: '/blogs/what-is-staking'
                    },
                    {
                        name: 'Native Assets',
                        href: '/terms/fungible-token-asset'
                    },
                    {
                        name: 'Smart Contracts',
                        href: '/terms/plutus-application'
                    }
                ],
                readMore: {
                    name: 'View all terminology',
                    href: '/terminology'
                }
            },
            technical: {
                ...
                navItems: [
                    {
                        name: 'Run a stake pool',
                        href: '/blogs/run-a-stake-pool'
                    },
                    {
                        name: 'Register your stake pool',
                        href: '/blogs/register-your-stake-pool'
                    },
                    {
                        name: 'Market your stake pool',
                        href: '/blogs/market-your-stake-pool'
                    },
                ],
                readMore: {
    ...
    fs.writeFileSync(basePath + "/topology.json", JSON.stringify(topology, null, 2))
