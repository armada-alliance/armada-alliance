...
function NextArrow(props) {
    ...
    return (
        <div
            ...
            className={cx(className, "flex items-center justify-center h-12 w-12 shadow-md bg-white text-primary-500 hover:bg-white hover:text-primary-500 rounded-l-full md:rounded-full")}
            css={[
                css`
          &:before {
            content: "" !important;
...
function PrevArrow(props) {
    ...
    return (
        <div
            ...
            className={cx(className, "flex items-center justify-center h-12 w-12 shadow-md bg-white text-primary-500 hover:bg-white hover:text-primary-500 rounded-r-full md:rounded-full")}
            css={[
                css`
          &:before {
            content: "" !important;
