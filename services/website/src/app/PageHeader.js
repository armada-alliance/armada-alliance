                    ...
                    <WithPageTooltip slug={identity.link.href}>
                        {(props) => (
                            <Link key={identity.id} href={identity.link.href}>
                                <a {...props} className="group flex flex-nowrap items-center px-3 py-2 space-x-2 rounded-lg bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-300 hover:bg-gray-200 transition-colors duration-50">
                                    <div className="bg-white dark:bg-gray-700 dark:group-hover:bg-gray-600 h-8 w-8 rounded-full overflow-hidden bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `url(${formatImage(identity.image)})` }} />
