...
export default function CopyToClipboardButton(props) {
    ...
    return (
        <CopyToClipboard text={text} onCopy={handleCopy}>
            <button type="button" className="flex items-center justify-center relative w-9 h-9 rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 text-gray-400 hover:text-gray-600 group ml-1" style={copied ? { color: '#06B6D4' } : null} onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>
